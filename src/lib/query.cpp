...
{
    qInfo() << "<baloosearch>Search string:" << str;
...
Query Query::fromJSON(const QByteArray& arr)
{
    ...
    qCInfo(BALOO) << "m_types:" << query.d->m_types;
    ...
    qCInfo(BALOO) << "m_limit:" << query.d->m_limit;
    ...
    qCInfo(BALOO) << "m_offset:" << query.d->m_offset;
    qCInfo(BALOO) << "m_searchString:" << query.d->m_searchString;
    qCInfo(BALOO) << "m_term:" << query.d->m_term;
    ...
    qCInfo(BALOO) << "m_yearFilter:" << query.d->m_yearFilter << ", m_monthFilter:" << query.d->m_monthFilter << ", m_dayFilter:" << query.d->m_dayFilter;
    ...
    qCInfo(BALOO) << "m_sortingOption:" << query.d->m_sortingOption;
    ...
    qCInfo(BALOO) << "m_includeFolder:" << query.d->m_includeFolder;
